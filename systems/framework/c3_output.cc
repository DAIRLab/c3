...
lcmt_output C3Output::GenerateLcmObject(double time) const {
  lcmt_output c3_output;
  lcmt_solution c3_solution;
  lcmt_intermediates c3_intermediates;
  ...
  c3_output.solution = c3_solution;
  c3_output.intermediates = c3_intermediates;
