...
struct C3Options {
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(DRAKE_NVP(final_augmented_cost_contact_indices));
    ...
    std::vector<double> g_eta_vector = g_eta.value_or(std::vector<double>());
